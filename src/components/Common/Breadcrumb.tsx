...
const Breadcrumb: React.FC<BreadcrumbProps> = ({
  ...
  return (
    <div className="dark:bg-darkmode relative z-10 overflow-hidden pb-3.75 pt-[120px] md:pt-[130px] lg:pt-40">
            ...
            <div className="text-center">
              ...
              <ul className="flex items-center justify-center gap-2.5">
                <li>
                  <Link
                    href="/"
                    className="text-black flex items-center gap-2.5 text-base font-medium dark:text-white dark:text-opacity-50"
                  >
                    Home
                  </Link>
                </li>

        ...
        <div className="grid md:grid-cols-12 items-center gap-7">
          ...
          >
            ...
            <h2 className="pt-9 pb-8 text-midnight_text font-bold dark:text-white text-4xl">
              Your Digital Workhorse: We Build, Scrape, and Manage.
            </h2>
            <p className="text-gray dark:text-white/70 text-base font-semibold">
              The relentless force behind your digital operations. We handle the
              heavy lifting of code, data, and tasks, so your business can run
              faster and smarter.
            </p>
